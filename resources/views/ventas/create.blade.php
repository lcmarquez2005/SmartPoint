...
<div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-start mb-0">Nueva Venta</h2> <!-- Título a la izquierda -->
        ...
        <form class="card-body" method="POST" action="{{route('detalle.create') }}">
            ...
            <div class="row g-2">
                <div class="col-md-2">
                    ...
                    <input name="cod_pro" id="producto_codigo" type="text" class="form-control form-control-sm" value="{{ isset($producto->cod_pro) ? $producto->cod_pro : '' }}" autofocus>
                </div>
                ...
                <div class="col-md-1">
                    ...
                    <input id="producto_cantidad" name="cantidad" type="number" class="form-control form-control-sm" value="1" min="1">
                </div>
                <div class="col-md-1 justify-content-center align-items-end d-flex">
